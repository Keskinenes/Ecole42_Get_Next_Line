...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2022/08/22 14:36:58 by enkeskin          #+#    #+#             */
/*   Updated: 2022/08/22 18:13:27 by enkeskin         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int main()
{
	...
	static char *str;
	static char *str2;
	fd = open("aa.txt", O_CREAT | O_RDWR, 0777);
	fd1 = open("bb.txt", O_CREAT | O_RDWR, 0777);
